%%%set all of these!
masterdir = '/d6/Texas'; %For now, set this by hand, make sure it exists, and run from this dir.
track     = 173; %track for ERS/ENVI, path for ALOS
frame     = [620]; %frame for ERS/ENVI, row for ALOS.  Can be vector of multiple adjacent frames
...
datamode = 1; %1 = download, 2=already downloaded, in masterdir
plotflag = 1;
