...
mysys(command);
command=(['process_2pass.pl ' procname ' slcs begin_filt']);
mysys(command);
...
input(1).val=num2str(aff1/Simrlks); %needs to be fixed for non-2rlks
input(2).val=num2str(aff2/Simrlks);
